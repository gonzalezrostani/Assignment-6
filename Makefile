...
# This Makefile is part of the assignment 7 where I need to create a branch and the output should be a pdf and a html file called All.  

#This files contains the target to create my website

#My steps:
#      1. re-size the figure and add a line after that (well after the master of Assignment 6 and 7 changed I am not re-sizing the image, but in this step I still add an empty line after the size) 
...
#Here I am creating an HTML file and a PDF
All : content.md
	pandoc content.md -s --mathjax -f markdown+tex_math_dollars -t html -o All.html | pandoc -t latex -o All.pdf
...
#Here I am adding an empty line after litRevie
